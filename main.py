...
class ScrapeRequest(BaseModel):
    ...
    pause_between_places_sec: int = Field(3, ge=0, le=60)
...
app = FastAPI(
    ...
    description="Extract reviews from any Google Maps place. Pay $0.10 USDC per call.",
    version="1.0.0",
)
